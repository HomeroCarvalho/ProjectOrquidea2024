...
{
    /// <summary>
    /// classe que implementa um processamento de Aspecto.
    /// </summary>
    public class Aspecto
    {
        ...
        /// <summary>
        /// funcao de corte, implementa o aspecto toda vez que um objeto/metodo for processado em alguma expressão,
        /// </summary>
        ...
        /// <summary>
        /// nome do metodo interceptado.
        /// </summary>
        private string nomeMetodo { get;  set; }

        /// <summary>
        /// lista de instruções a executar quando se atinge o objeto/metodo, em alguma expressão.
        /// </summary>
        private List<Instrucao> instrucoesDeCorte { get; set; }

        /// <summary>
        /// tipo de inserçao da funcao de corte.
        /// </summary>
        ...
        /// construtor.
        /// </summary>
        /// <param name="nameAspect">nome do aspecto.</param>
        /// <param name="nomeTipoDoObjeto">nome do tipo do objeto interceptado.</param>
        /// <param name="nomeMetodo">ou nome do metodo interceptado.</param>
        /// <param name="instrucoesDoCorte">lista de instruções executados quando a função de corte é acionada.</param>
        /// <param name="escopo">contexto onde o aspecto está.</param>
        /// <param name="tipoAlgoritmo">tipo do algoritmo aspecto: objeto, metodo.</param>
        /// <param name="tipoInsercao">tipo de inserção: antes, depois, ou antes e depois da interceptação.</param>
        ...
        /// </summary>
        /// <param name="nameAspect">nome do aspecto.</param>
        /// <param name="nomeTipoDoObjeto">nome do tipo do objeto a interceptar.</param>
        /// <param name="nomeMetodo">ou nome do metodo a interceptar.</param>
        /// <param name="functionCutter">metodo executado quando a função corte é acionada.</param>
        /// <param name="escopo">contexto onde o aspecto está.</param>
        /// <param name="tipoAlgoritmo">tipo de algoritmo: objeto, metodo.</param>
        /// <param name="tipoInsercao">tipo de inserção da função de corte: antes, depois, ou antes e depois, do objeto, metodo for identificado.</param>
        ...
        /// </summary>
        /// <param name="instanciaObjeto">expressao objeto a interceptar.</param>
        /// <returns></returns>
        ...
        /// </summary>
        /// <param name="instanciaObjeto">expressao objeto a interceptar.</param>
        /// <param name="nomeMetodo">nome do metodo a interceptar.</param>
        /// <returns></returns>
