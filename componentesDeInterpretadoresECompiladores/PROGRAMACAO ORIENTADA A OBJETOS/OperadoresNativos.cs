...
namespace parser
{
    ...
    {
        public string nome;
        public static List<Metodo> funcaoImplOperadores = new List<Metodo>();
        public static List<MethodInfo> metodosImpl = new List<MethodInfo>();
        ...
        private static Assembly assemblyToImporter = null;
        ...
        public OperadoresImplementacao(string nameAssembly, string nameClassWithOperators)
        {
            ...
            assemblyToImporter = Assembly.LoadFile(Path.GetFullPath(nameAssembly));
        ...
        public static List<Operador> operadoresInt = new List<Operador>();
        public static List<Operador> operadoresDouble= new List<Operador>();
        public static List<Operador> operadoresFloat = new List<Operador>();
        public static List<Operador> operadoresString = new List<Operador>();
        public static List<Operador> operadoresChar = new List<Operador>();
        public static List<Operador> operadoresBoolean = new List<Operador>();
        public static List<Operador> operadoresMatriz = new List<Operador>();


        /// <summary>
        /// constroi um operador a partir da metodos importados da classe base.
        /// </summary>
        /// <param name="nameClassOperator">nome da classe que o operador pretence.</param>
        ///<param name="nameOperatorInOrquidea">nome da classe que implementa os operadores</param>
        ...
        /// <returns></returns>
        public Operador GetOperatorComMetodoImportado(string nameClassOperator, string classOperadores, string nameMethodImpl, string nameOperatorInOrquidea, int prioridade)
        {
            if ((metodosImpl==null) || (metodosImpl.Count == 0) || (assemblyToImporter == null))
            {
                assemblyToImporter = Assembly.LoadFile(Path.GetFullPath(nameAssembly));
                 types= assemblyToImporter.GetTypes();
                if (types != null)
                {
                    for (int i = 0; i < types.Length; i++)
                    {
                        if (types[i].GetMethods() != null)
                        {
                            for (int j = 0; j < types[i].GetMethods().Length; j++)
                            {
                                metodosImpl.AddRange(types[i].GetMethods());
                            }
                        }
                    }
                }
            ...
            int indexClass = types.ToList<Type>().FindIndex(k => k.Name == classOperadores);
            int indexMethodo = -1;
            if (indexClass != -1) 
            {
                indexMethodo = types[indexClass].GetMethods().ToList<MethodInfo>().FindIndex(k => k.Name == nameMethodImpl);
            }

            if (indexMethodo != -1)
            {
                MethodInfo metodoImpl = types[indexClass].GetMethods()[indexMethodo];
                ...
                Operador op = new Operador(nameClassOperator, nameOperatorInOrquidea, prioridade, objParametros.ToArray(), tipo, metodoImpl, escopoImpl);
        ...
        {
            if ((operadoresInt == null) || (operadoresInt.Count == 0))
            {

                
                OperadoresImplementacao implementacaoInt = new OperadoresImplementacao(@"ProjectOrquidea2024.dll", "parser.OperadoresInt");
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt","Resto", "%", 5));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "NumeroNegativo", "-", 6));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "NumeroPositivo", "+", 6));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "Soma", "+", 2));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "Sub", "-", 2));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "Mult", "*", 3));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "Div", "/", 3));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "Igual", "=", 1));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "ComparacaoIgual", "==", 1));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "Desigual", "!=", 1));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "Maior", ">", 1));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "MaiorOuIgual", ">=", 1));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "Menor", "<", 1));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "MenorOuIgual", "<=", 1));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "IncrementoUnario", "++", 6));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "DecrementoUnario", "--", 6));
                operadoresInt.Add(implementacaoInt.GetOperatorComMetodoImportado("int","OperadoresInt", "Potenciacao", "^", 6));

                OperadoresImplementacao implementacaoDouble = new OperadoresImplementacao(@"ProjectOrquidea2024.dll", "parser.OperadoresDouble");

                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble","NumeroNegativo", "-", 6));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble","NumeroPositivo", "+", 6));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble","Soma", "+", 2));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble","Sub", "-", 2));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble","Mult", "*", 3));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble","Div", "/", 3));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble","Igual", "=", 1));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble","ComparacaoIgual", "==", 1));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble","Desigual", "!=", 1));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble","Maior", ">", 1));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble", "MaiorOuIgual", ">=", 1));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble", "Menor", "<", 1));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble","MenorOuIgual", "<=", 1));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble","IncrementoUnario", "++", 6));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble","DecrementoUnario", "--", 6));
                operadoresDouble.Add(implementacaoDouble.GetOperatorComMetodoImportado("double","OperadoresDouble","Potenciacao", "^", 6));

                

                OperadoresImplementacao implementacaoFloat = new OperadoresImplementacao(@"ProjectOrquidea2024.dll", "parser.OperadoresFloat");
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","NumeroNegativo", "-", 6));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","NumeroPositivo", "+", 6));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","Soma", "+", 2));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","Sub", "-", 2));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","Mult", "*", 3));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","Div", "/", 3));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","Igual", "=", 1));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","ComparacaoIgual", "==", 1));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","Desigual", "!=", 1));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","Maior", ">", 1));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","MaiorOuIgual", ">=", 1));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","Menor", "<", 1));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","MenorOuIgual", "<=", 1));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","IncrementoUnario", "++", 6));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","DecrementoUnario", "--", 6));
                operadoresFloat.Add(implementacaoFloat.GetOperatorComMetodoImportado("float","OperadoresFloat","Potenciacao", "^", 6));



                OperadoresImplementacao implmentacaoString = new OperadoresImplementacao(@"ProjectOrquidea2024.dll", "parser.OperadoresString");
                operadoresString.Add(implmentacaoString.GetOperatorComMetodoImportado("string","OperadoresString","Soma", "+", 2));
                operadoresString.Add(implmentacaoString.GetOperatorComMetodoImportado("string","OperadoresString", "Sub", "-", 2));
                operadoresString.Add(implmentacaoString.GetOperatorComMetodoImportado("string","OperadoresString", "Igual", "=", 1));
                operadoresString.Add(implmentacaoString.GetOperatorComMetodoImportado("string","OperadoresString", "ComparacaoIgual", "==", 3));
                operadoresString.Add(implmentacaoString.GetOperatorComMetodoImportado("string","OperadoresString","Desigual", "!=", 3));
                operadoresString.Add(implmentacaoString.GetOperatorComMetodoImportado("string","OperadoresString", "Maior", ">", 3));
                operadoresString.Add(implmentacaoString.GetOperatorComMetodoImportado("string","OperadoresString", "MaiorOuIgual", ">=", 3));
                operadoresString.Add(implmentacaoString.GetOperatorComMetodoImportado("string","OperadoresString", "Menor", "<", 3));
                operadoresString.Add(implmentacaoString.GetOperatorComMetodoImportado("string","OperadoresString", "MenorOuIgual", "<=", 3));

                
                
                OperadoresImplementacao implmentacaoChar = new OperadoresImplementacao(@"ProjectOrquidea2024.dll", "parser.OperadoresString");
                operadoresChar.Add(implmentacaoChar.GetOperatorComMetodoImportado("char","OperadoresChar","Igual", "=", 1));
                operadoresChar.Add(implmentacaoChar.GetOperatorComMetodoImportado("char","OperadoresChar","ComparacaoIgual", "==", 2));
                operadoresChar.Add(implmentacaoChar.GetOperatorComMetodoImportado("char","OperadoresChar", "Desigual", "!=", 2));
                operadoresChar.Add(implmentacaoChar.GetOperatorComMetodoImportado("char","OperadoresChar", "Maior", ">", 2));
                operadoresChar.Add(implmentacaoChar.GetOperatorComMetodoImportado("char","OperadoresChar", "MaiorOuIgual", ">=", 2));
                operadoresChar.Add(implmentacaoChar.GetOperatorComMetodoImportado("char","OperadoresChar", "Menor", ">", 2));
                operadoresChar.Add(implmentacaoChar.GetOperatorComMetodoImportado("char","OperadoresChar", "MenorOuIgual", ">=", 2));


                OperadoresImplementacao implmentacaoBooleanean = new OperadoresImplementacao(@"ProjectOrquidea2024.dll", "parser.OperadoresBooleanean");
                operadoresBoolean.Add(implmentacaoBooleanean.GetOperatorComMetodoImportado("bool","OperadoresBoolean", "Igual", "=", 1));
                operadoresBoolean.Add(implmentacaoBooleanean.GetOperatorComMetodoImportado("bool","OperadoresBoolean", "ComparacaoIgual", "==", 1));
                operadoresBoolean.Add(implmentacaoBooleanean.GetOperatorComMetodoImportado("bool","OperadoresBoolean", "Desigual", "!=", 1));
                operadoresBoolean.Add(implmentacaoBooleanean.GetOperatorComMetodoImportado("bool","OperadoresBoolean", "Not", "!", 1));
                

                OperadoresImplementacao implmentacaoMatriz = new OperadoresImplementacao(@"ProjectOrquidea2024.dll", "parser.OperadoresMatriz");
                operadoresMatriz.Add(implmentacaoMatriz.GetOperatorComMetodoImportado("Matriz","OperadoresMatriz", "Soma", "+", 2));
                operadoresMatriz.Add(implmentacaoMatriz.GetOperatorComMetodoImportado("Matriz","OperadoresMatriz", "Sub", "-", 2));
                operadoresMatriz.Add(implmentacaoMatriz.GetOperatorComMetodoImportado("Matriz","OperadoresMatriz", "Mult", "*", 3));
                operadoresMatriz.Add(implmentacaoMatriz.GetOperatorComMetodoImportado("Matriz","OperadoresMatriz", "Div", "/", 3));
                operadoresMatriz.Add(implmentacaoMatriz.GetOperatorComMetodoImportado("Matriz","OperadoresMatriz", "Igual", "=", 1));
                operadoresMatriz.Add(implmentacaoMatriz.GetOperatorComMetodoImportado("Matriz","OperadoresMatriz", "Maior", ">", 1));
                operadoresMatriz.Add(implmentacaoMatriz.GetOperatorComMetodoImportado("Matriz","OperadoresMatriz", "MaiorOuIgual", ">=", 1));
                operadoresMatriz.Add(implmentacaoMatriz.GetOperatorComMetodoImportado("Matriz","OperadoresMatriz", "Menor", "<", 1));
                operadoresMatriz.Add(implmentacaoMatriz.GetOperatorComMetodoImportado("Matriz","OperadoresMatriz", "Menor", "<=", 1));
                operadoresMatriz.Add(implmentacaoMatriz.GetOperatorComMetodoImportado("Matriz","operadoresMatriz", "ComparacaoIgual", "==", 1));
            }
        }
        ...
        public List<Metodo> GetImplementacao(string classeOperador)
        {
            ...
            metodosImpl = metodosmplementadores.ToList<MethodInfo>();
            ...
            foreach (MethodInfo umMetodoImpl in metodosmplementadores)
            {
                ...
                if (tipoOperador != null)
                {
                    ...
                    funcaoImplOperadores.Add(fncImplementador1);
                }
                
            }
            return funcaoImplOperadores;
        }
        ...
        public void AdicionaOperadorNativo(string nomeOperador, MethodInfo umMetodoImpl, int prioridade, string classeDoOperador)
        {
            ...
            funcaoImplOperadores.Add(fncImplementador);
        }
