...
namespace parser
{
    public class FileHeader
    {
        ...
        {
            if (cabecalhoDeClasses == null){
                cabecalhoDeClasses = new List<HeaderClass>();
            }
            
            int indexOffseet = 0;
            ExtraiHEADERS_CLASSES_ORQUIDEA(classesDoRepositorio, headersClasse, indexOffseet, true);
        }

        public void ExtraiHEADERS_CLASSES_ORQUIDEA(List<Classe> classesDoRepositorio, List<HeaderClass> headersClasse, int indexOffseet, bool isToIncludeInHeader)
        {
                ...
                for (int x = 0; x < classesDoRepositorio.Count; x++)
                {
                    ...
                    if (umaClasse.GetPropriedades() != null)
                    {
                        ...
                        for (int i = 0; i < property.Count; i++)
                        {
                            ...
                            headerPropriedade.typeOfProperty = property[i].GetTipo();
                    ...
                    if (umaClasse.GetMetodos() != null)
                    {
                        ...
                        for (int i = 0; i < methods.Count; i++)
                        {
                            ...
                            headerMetodo.typeOfProperty = umaClasse.nome;
                            headerMetodo.name = methods[i].nome;
                            headerMetodo.typeReturn = methods[i].tipoReturn;
                            headerMetodo.classNameOfProperty = nomeClasse;
                    ...
                    if (umaClasse.GetOperadores() != null)
                    {
                        ...
                        for (int i = 0; i < operators.Count; i++)
                        {
                            ...
                            headerOperador.typeOfProperty = operators[i].nomeClasse;
                    ...
                    if (isToIncludeInHeader)
                    {
                        if ((cabecalhoDeClasses != null) && (cabecalhoDeClasses.Count > 0))
                        {
                            int indiceClasseJaArmazenadaComMesmoNome = cabecalhoDeClasses.FindIndex(k => k.nomeClasse == umHeaderClasse.nomeClasse);
                            if (indiceClasseJaArmazenadaComMesmoNome != -1)
                            {
                                cabecalhoDeClasses.RemoveAt(indiceClasseJaArmazenadaComMesmoNome);
                            }
                        }
            ...
            if (metodo.parametrosDaFuncao != null)
            {
                ...
                if (parametros != null)
                    for (int k = 0; k < parametros.Count; k++)
                    {
                        ...
                        propertyParameter.typeOfProperty = tipoParametro;
        ...
        public class Testes : SuiteClasseTestes
        {
            ...
            public void TestePropriedadesEFuncoesEstaticas(AssercaoSuiteClasse assercao)
            {
                string code_class = "public class entity { public static int b;  public int x; public int y; public entity(){x=1; y=5;}; public void metodoB(){};};";

                FileHeader fileHeader = new FileHeader();
                fileHeader.ExtractCabecalhoDeClasses(code_class);
            ...
            public void TesteParametroWrapperObjectsParameters(AssercaoSuiteClasse assercao)
            {
                string codigoClasse = "public class classeA { public int propriedadeA = 1 ; public int metodoB(:r DictionaryText d1{ string },! Vector y , JaggedArray j1, Matriz m1){ return 5;} ;};";
                FileHeader headers = new FileHeader();
                headers.ExtractCabecalhoDeClasses(codigoClasse);

                try
                {
                    assercao.IsTrue(headers.cabecalhoDeClasses[0].methods[0].parameters[1].isMultArgument, codigoClasse);
                    assercao.IsTrue(headers.cabecalhoDeClasses[0].methods[0].parameters[1].tipoElemento == "Object", codigoClasse);
                    assercao.IsTrue(headers.cabecalhoDeClasses[0].methods[0].parameters[0].tipoElemento == "string", codigoClasse);
                    assercao.IsTrue(headers.cabecalhoDeClasses[0].methods[0].parameters[0].isReadOnly == true, codigoClasse);
                    assercao.IsTrue(headers.cabecalhoDeClasses[0].methods[0].parameters[2].tipoElemento == "Object", codigoClasse);
                    assercao.IsTrue(headers.cabecalhoDeClasses[0].methods[0].parameters[3].tipoElemento == "double", codigoClasse);
                }
                catch (Exception ex)
                {
            ...
            {
                string codigoClasseA = "public class classeA {public string variavel1="+aspas+"5"+aspas+"; public int variavel2;  public int metodoB(int x, int y) {int b=3;} ; public classeA() { int b=2;};  }";
                ...
                ProcessadorDeID compilador = new ProcessadorDeID(tokensClasse);
                compilador.Compilar();
            ...
            public void TestePropriedadeProtected(AssercaoSuiteClasse assercao)
            {
                ...
                try
                {
                    ...
                    assercao.IsTrue(headers.cabecalhoDeClasses[0].methods[1].acessor == "public", codigoClasse);
                }
                catch (Exception ex)
                {
                    string erroMessage = ex.Message;
            ...
            public void TesteParametrosPropriedadesWrapperObject(AssercaoSuiteClasse assercao)
            {
                ...
                try
                {
                    assercao.IsTrue(header2.cabecalhoDeClasses[0].properties[0].typeOfProperty == "Vector", codigoClasseA);
                    assercao.IsTrue(header2.cabecalhoDeClasses[0].methods[0].parameters[0].typeOfProperty == "Vector", codigoClasseA);
    ...
    public class HeaderClass
    {
            ...
            while (i < this.tokensDaClasse.Count)
            {
                ...
                if (IsID(tokenCURR))
                {
                    ...
                    if ((tokensID.Count == 1) && (i + 1 < tokensDaClasse.Count) && (tokensDaClasse[i + 1] != "("))
                    {
                        ...
                        if ((BuildParametrosWrapperObject(ref i, tokensDaClasse, ref property, false)) && (property != null)) 
                        {
                            
                            property.isMultArgument = isMultArgument;
                            property.isStatic = isStatic;
                            property.isWrapperObject = true;
                    ...
                    // PROCESSAMENTO DE METODO COM/SEM TIPO DE RETORNO,ESTATICO OU NAO.
                    if ((tokensID.Count == 1) && (i + 1 < tokensDaClasse.Count) && (tokensDaClasse[i + 1] == "(")) 
                    {
                        if (acessorCurr == "")
                        {
                        ...
                        bool fncSStatic = false;
                        int indexStartParams = tokensDaClasse.IndexOf("(", i);
                        if (indexStartParams >= 0)
                        {
                            // calculo do tipo de retorno do metodo.
                            if ((indexStartParams - 2) >= 0)
                            {
                                string tokenAcessorOuTipoRetorno = tokensDaClasse[indexStartParams - 2];
                                if ((tokenAcessorOuTipoRetorno != "public") &&
                                    (tokenAcessorOuTipoRetorno != "private") &&
                                    (tokenAcessorOuTipoRetorno != "protected"))
                                {
                                    typeReturn = tokenAcessorOuTipoRetorno;
                                }
                            }
                            // calculo do termo [static].
                            if ((indexStartParams - 2 >= 0) && (tokensDaClasse[indexStartParams - 2] == "static"))
                            {
                                 fncSStatic= true;
                            }
                            ...
                            i += 1;
                            if ((tokensDaInterfaceParametros == null) || (tokensDoCorpoDoMetodo == null))
                            {
                                if (tokensDaInterfaceParametros != null)
                                {
                                    i += tokensDaInterfaceParametros.Count;
                                }
                                if (tokensDoCorpoDoMetodo != null)
                                {
                                    i += tokensDoCorpoDoMetodo.Count;
                                }
                    ...
                    if (tokensID.Count == 2)
                    {
                        ...
                        if ((this.tokensDaClasse[i + 1] == ";") || (this.tokensDaClasse[i + 1] == "="))
                        {
                            ...
                            if (this.tokensDaClasse[i + 1] == ";")
                            {
                                ...
                                HeaderProperty property = new HeaderProperty( acessorCurr, nomePropriedade, nomeClassePropriedade, isStatic, null, null);
                                property.isMultArgument = isMultArgument;
                                property.isStatic = isStatic;
                                property.classNameOfProperty = nomeClasse;
                                this.properties.Add(property);
        ...
        public static bool BuildParametrosWrapperObject(ref int indexTOKEN, List<string> tokensProperty, ref HeaderProperty property, bool isReadyOnly)
        {
            ...
            for (int i = 0; i < FileHeader.wrapperDefinition.Count; i++)
            {
                ...
                if (FileHeader.wrapperDefinition[i].isThisTypeWrapperParameter(tokens, indexTOKEN) != null)
                {
                    ...
                    property.typeOfProperty = FileHeader.wrapperDefinition[i].GetTipo();
                    property.isReadOnly = isReadyOnly;
                        ...
                        if (headerHerdado.properties != null)
                        {
                            for (int i = 0; i < headerHerdado.properties.Count; i++)
                                if ((headerHerdado.properties[i].acessor == "public") || (headerHerdado.properties[i].acessor == "protected"))
                                {
                                    ...
                                    propriedadeHerdada.name = headerHerdado.properties[i].typeOfProperty + "." + headerHerdado.properties[i].name;
                        ...
                        if (headerHerdado.methods != null)
                        {
                            for (int i = 0; i < headerHerdado.methods.Count; i++)
                                if ((headerHerdado.methods[i].acessor == "public") || (headerHerdado.methods[i].acessor == "protected"))
                                {
                                    ...
                                    metodoHerdado.name = metodoHerdado.typeOfProperty + "." + headerHerdado.methods[i].name;
                        ...
                        if ((classe.properties != null) && (headerDeserdado.properties != null))
                            for (int i = 0; i < headerDeserdado.properties.Count; i++)
                            {
                                ...
                                int indexPropriedadeDeserdada = classe.properties.FindIndex(
                                    k => k.name == headerDeserdado.properties[i].name && k.typeOfProperty == headerDeserdado.properties[i].typeOfProperty);
                        ...
                        if ((classe.methods != null) && (headerDeserdado.methods != null))
                            for (int i = 0; i < headerDeserdado.methods.Count; i++)
                            {
                                ...
                                int indexMetodoDeserdado = classe.methods.FindIndex(
                                     k => k.name == headerDeserdado.methods[i].name && k.typeOfProperty == headerDeserdado.methods[i].typeOfProperty);
                        ...
                        if ((classe.operators != null) && (headerDeserdado.operators != null))
                            for (int i = 0; i < headerDeserdado.operators.Count; i++)
                            {
                                ...
                                int indexOperadorDeserdado = classe.operators.FindIndex(
                                    k => k.typeOfProperty == headerDeserdado.operators[i].typeOfProperty && k.name == headerDeserdado.operators[i].name);
    ...
    public class ObjectHeader
    {
        ...
        public string classNameOfProperty;
        public string name;
    ...
    public class HeaderProperty : ObjectHeader
    {
        ...
        public override string ToString()
        {
            string str = typeOfProperty + "." + name;
    ...
    public class HeaderMethod : HeaderProperty
    {
        ...
        public HeaderMethod(string classNameMethod, string nameMethod)
        {
            ...
            this.typeOfProperty = classNameMethod;
            this.tokens = new List<string>();
        ...
        public void BuildParmeters(List<string> tokensRaw, int offset)
        {
            ...
            while (i < tokensParameters.Count)
            {
                ...
                if ((i + 1 < tokensParameters.Count) && (tokensParameters[i + 0] == ":") && (tokensParameters[i + 1] == "r"))
                {
                    isReadOnly = true;
                    lstTokensParametroCurr.RemoveAt(i);
                    tokensParameters.RemoveRange(i, 2);
                    continue;
                }
                else
                if (tokenCurr == "!")
                ...
                if (MethodProperty.ValidateMethodParameter(tokensParameters, i))
                {
                    ...
                    if (metodoParamero != null)
                    {
                        ...
                        metodoParamero.isReadOnly = false;
                ...
                if (HeaderClass.BuildParametrosWrapperObject(ref i, tokensParameters, ref parametroWrapperObject, isReadOnly)) 
                {
                    ...
                    parametroWrapperObject.isReadOnly= isReadOnly;
                    ...
                    (pilhaColchetes == 0))
                {
                    ...
                    ExtractParameterNormal(ref lstTokensParametroCurr, ref isMultArgument, ref i, ref parameters, ref isReadOnly);
                    parameters[parameters.Count - 1].isReadOnly = isReadOnly;
            ...
            {
                ExtractParameterNormal(ref lstTokensParametroCurr, ref isMultArgument, ref i, ref this.parameters, ref isReadOnly);
                this.parameters[this.parameters.Count - 1].isReadOnly = isReadOnly;
                isReadOnly = false;
            }
            else
        ...
        private static void ExtractParameterNormal(ref List<string> lstTokensParametroCurr, ref bool isMultArgument, ref int i, ref List<HeaderProperty> parameters, ref bool isReadOnly)
        {
            ...
            if ((lstTokensParametroCurr != null) && (lstTokensParametroCurr.Count > 1))
            {
                ...
                HeaderProperty property = new HeaderProperty("private", lstTokensParametroCurr[indexName], lstTokensParametroCurr[indexTipo], false, lstTokensParametroCurr, null);
        ...
        public override string ToString()
        {
            string str = typeReturn + " " + typeOfProperty + "." + name;
            if (parameters != null)
            {
                str += "(";
