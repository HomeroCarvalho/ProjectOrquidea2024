...
{
    /// <summary>
    /// obtém classes da linguagem base: C Sharp, e as transfere para o repositório de classes do orquidea.
    /// importa métodos, e propriedades da classe.
    /// </summary>
    class ImportadorDeClasses
    {
        ...
        /// <summary>
        /// carrega uma biblioteca externa. a biblioteca assembly fica na lista estática [LinguagemOrquidea.libraries].
        /// </summary>
        /// <param name="aplicacaoEXEouBibliotecaDLL">nome do arquivo da biblioteca.</param>
        public ImportadorDeClasses(string aplicacaoEXEouBibliotecaDLL)
        {
            ...
            /// guarda o assembly, como uma biblioteca de classes externas.
            LinguagemOrquidea.libraries.Add(this.assemblyToImporter);
        ...
        /// <summary>
        /// faz a importacao de todas classes no [Assembly] biblioteca.
        /// </summary>
        ...
        /// <summary>
        /// faz a importacao de classe importada: MethodInfo, ConstructorInfo, são carregado e instanciados metodos, propriedades.
        /// </summary>
        /// <param name="umTipoClasse">tipo da classe.</param>
        ...
        private void TransfereMetodosEPropriedadesParaOReposicorioDeClassesOrquidea(Type myType)
        {
            ...
            // seta a classe como classe importada.
            classeImportada.isImport = true;

            // registra a classe como uma classe orquidea! seus metodos e propriedades
            // podem ser escritos em codigo para o compilador, nao havera diferença...
            RepositorioDeClassesOO.Instance().RegistraUmaClasse(classeImportada); 
        ...
        private void RegistraMetodosImportados(MethodInfo[] infoMetodos, List<Metodo> metodos)
        {
            ...
            foreach(MethodInfo umMetodo in infoMetodos)
            {
                ...
                string tipoRetorno = UtilTokens.Casting(umMetodo.ReturnType.Name);

                // a função importada é adicionada na lista de métodos para a classe importada.
                metodos.Add(new Metodo(umMetodo.DeclaringType.Name, acessor, umMetodo.Name, umMetodo, tipoRetorno, parametros.ToArray()));
                // valida se o metodo é estático.
                metodos[metodos.Count - 1].isStatic = umMetodo.IsStatic;
