...
namespace parser.Manutencao
{
    public class CorpoTestesManutencao
    {
        ...
        private void TesteParaParserQualquerLinguagem(Assercoes assercao)
        {
            ...
            TokenizadorAnyLanguage parser = new TokenizadorAnyLanguage();
        ...
        private void TesteObjetosXML(Assercoes assercao)
        {
            ...
            assercao.IsTrue((objeto1Lido.GetNome().Equals(objetoEscrito.GetNome())) && ((objeto1Lido.GetProperty("a") != null)) && (objetoEscrito.GetProperty("a") != null));
