...
namespace parser
{
    class CorpoTestes_2
    {
        ...
        private void TesteGetExpressoes(Assercoes assercao)
        {
            ...
            List<string> tokensPolemico1 = Tokenizer.GetTokens(Util.UtilString.UneLinhasLista(codigoPolemico1));
            ...
            List<string> tokensPolemico2 = Tokenizer.GetTokens(Util.UtilString.UneLinhasLista(codigoPolemico2));
        ...
        private void TesteObterProducoes(Assercoes assercao)
        {
            ...
            List<string> tokens = Tokenizer.GetTokens(Util.UtilString.UneLinhasLista(codigo));
        ...
        private void TesteValidacaoDeExpressaoCondicional(Assercoes assercao)
        {
            ...
            Expressao exprss = new Expressao(tokensExpressaoCondicional.ToArray(), escopo);
            bool result = Expressao.ValidaExpressaoCondicional(exprss);
...
///________________________________________________________________________________________________________________________________________________________________
        ...
        private void TesteExtracaoDeClasses(Assercoes assercao)
        {
            ...
            Escopo escopo = new Escopo(codigo);
            ExtratoresOO extrator = new ExtratoresOO(tokens, escopo);
