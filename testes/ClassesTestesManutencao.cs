...
namespace ParserLinguagemOrquidea.testes
{
    ...
    class ClasseTesteExpressoesNulas :SuiteClasseTestes
    {
        ...
        public void Teste_02(AssercaoSuiteClasse assercao)
        {
            ...
            List<string> tokensCodigo = Tokenizer.GetTokens(codigoExpressao);
    ...
    class ClasseTestesExtracaoDeExpressoesSemValidacao:SuiteClasseTestes
    {
        ...
        {
            List<string> tokensDaExpressao = Tokenizer.GetTokens(expressao);
    ...
    class ClasseTestesConstructor: SuiteClasseTestes
    {
        ...
        public void Teste_01(AssercaoSuiteClasse assercao)
        {
            ...
            assercao.IsTrue(int.Parse(processador.escopo.tabela.GetObjeto("objetoA", processador.escopo).GetProperty("a").GetValor().ToString()) == 1);
        }
    }
    ...
    class ClasseTestesPosicaoECodigo : SuiteClasseTestes
    {
        ...
        public void Teste_ParserTokens(AssercaoSuiteClasse assercao)
        {
            ...
            List<string> tokens = Tokenizer.GetTokens(codigoPolemico);
    ...
    class ClassesTestesManutencao
    {
        private class TestesCompilacaoExecucaoClasses : SuiteClasseTestes
        {
            ...
            public void Teste_06(AssercaoSuiteClasse assercao)
            {
                ...
                assercao.IsTrue((processador.escopo.tabela.GetObjeto("obj_C", processador.escopo).GetProperty("objD").GetValor() != null) && int.Parse(processador.escopo.tabela.GetObjeto("obj_C", processador.escopo).GetProperty("objD").GetValor().ToString()) == 3);
            ...
            public void Teste_03(AssercaoSuiteClasse assercao)
            {
                ...
                assercao.IsTrue((this.processador.escopo.tabela.GetObjeto("obj_C", processador.escopo).GetProperty("objB").GetProperty("objA").GetProperty("a").GetValor() != null) && int.Parse(this.processador.escopo.tabela.GetObjeto("obj_C", processador.escopo).GetProperty("objB").GetProperty("objA").GetProperty("a").GetValor().ToString()) == 2);
            ...
            public void Teste_05(AssercaoSuiteClasse assercao)
            {
                ...
                assercao.IsTrue((this.processador.escopo.tabela.GetObjeto("objetoA", processador.escopo) != null) &&
                    (processador.escopo.tabela.GetObjeto("objetoA", processador.escopo).GetProperty("a").GetValor() != null) &&
                    (int.Parse(processador.escopo.tabela.GetObjeto("objetoA", processador.escopo).GetProperty("a").GetValor().ToString()) == 2));
            }
            ...
            public void Teste_01(AssercaoSuiteClasse assercao)
            {
                ...
                // objetoB.objA.a=1
                assercao.IsTrue((this.processador.escopo.tabela.GetObjeto("objetoB", processador.escopo).GetProperty("objA").GetProperty("a").GetValor() != null) && int.Parse(this.processador.escopo.tabela.GetObjeto("objetoB", processador.escopo).GetProperty("objA").GetProperty("a").GetValor().ToString()) == 2);
            ...
            public void Teste_04(AssercaoSuiteClasse assercao)
            {
                ...
                assercao.IsTrue((processador.escopo.tabela.GetObjeto("obj_C", processador.escopo).GetProperty("objB").GetValor() != null) && (int.Parse(processador.escopo.tabela.GetObjeto("obj_C", processador.escopo).GetProperty("objB").GetValor().ToString()) == 2));
            ...
            public void Teste_02(AssercaoSuiteClasse assercao)
            {
                ...
                assercao.IsTrue((processador.escopo.tabela.GetObjeto("objetoA", processador.escopo).GetProperty("a").GetValor() != null) && int.Parse(processador.escopo.tabela.GetObjeto("objetoA", processador.escopo).GetProperty("a").GetValor().ToString()) == 2);
            }
        ...
        private class TestesCompilacaoDeExpressoesAninhadas : SuiteClasseTestes
        {
            ...
            {
                List<string> codigo = Tokenizer.GetTokens(codigoDefinicao);
        ...
        private class TestesExpressoesMatriciais:SuiteClasseTestes
        {
            ...
            private static List<string> GetExpressaoMatricial(string codigo)
            {
                ...
                codigoTokens = Tokenizer.GetTokens(codigo);
        ...
        private class TestesExpressoes : SuiteClasseTestes
        {
            ...
            private void ProcessaAExpressao(string definicoes, string chamadaExpressao)
            {
                ...
                List<string> tokensDaExpressao = Tokenizer.GetTokens(chamadaExpressao);
            ...
            public void Teste_Seis(AssercaoSuiteClasse assercao)
            {
                ...
                assercao.IsTrue(this.escopo.tabela.GetObjeto("c", escopo) != null && (int.Parse(this.escopo.tabela.GetObjeto("c", escopo).GetProperty("a").GetValor().ToString()) == 1));
            }
            ...
            public void Teste_Quatro(AssercaoSuiteClasse assercao)
            {
                ...
                List<string> tokensNumero = Tokenizer.GetTokens(expressaoNumeroPontoFlutuante);
                List<string> tokensCorretos = Tokenizer.ObtemPontosFlutuantes(tokensNumero);
